...
from sentence_transformers import SentenceTransformer # Use the local model library
import numpy as np
import os
import certifi
import hashlib
...
# --- LOAD LOCAL AI MODEL AND DATA ---
print("Loading local AI model... (This can take a moment on first start)")
...
def search():
    ...
    try:
        # Use the local model to get the vector
